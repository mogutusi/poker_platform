...
| **协议/解析错误** | 消息格式非法、字段缺失 | Receiver 层 | 没形成合法 `Command`,**不进 reduce**;直接构造 `ErrorMessage` 投该连接 Sender 队列 |
...
class ErrorCode(str, Enum):
    ...
    #  ILLEGAL_ACTION/NOT_ENOUGH_PLAYERS/NO_VOTE_IN_PROGRESS/NOT_A_VOTER/INVALID_BUY_IN 等)
