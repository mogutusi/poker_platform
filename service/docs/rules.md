...
- **已通过的快照也随人离房作废**:`_evict`——离房的唯一汇聚点(`LeaveRoom` / `Cleanup` 占座到期 / 观战者掉线 / 手尾驱逐)——把该 nick 从 `waive_entry_for` 剔除,且**只剔除他那一份**:这个集合是多人 union(同一票可免多人),整份清空会毁掉同批别人已获全票通过的免盲。与「冻结候选离场失对象」同一口径;不清的话,①.9「退房再进躲盲被堵」会被投票残留绕开,改名腾出的旧 nick 还能把免盲转给别人。
- **在座者掉线不弃权**:可逆、保座,与 ①.15「不为断线单独触发通过」同理;起身(→WATCHING)的人还在房里,也不弃权。
- 但**观战者掉线 = 即时离场**(0070),所以「起身之后再掉线」的人确实会弃权。这不是上一条的例外,而是「离房即弃权」的一致结果:他此刻真的离开了房间。
